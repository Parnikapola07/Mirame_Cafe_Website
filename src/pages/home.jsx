                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="relative min-h-[250px] flex items-center justify-center">
                            {slides.map((slide, index) => (
                                <div
                                    key={index}
                                    className={`absolute inset-0 transition-opacity duration-500 ease-in-out ${activeSlide === index ? 'opacity-100 z-10' : 'opacity-0 z-0'
                        ...
                        <div className="flex justify-center gap-4 mt-8 relative z-20">
                            {slides.map((_, index) => (
                                <button
                                    ...
                                    className={`w-3 h-3 rounded-full transition-all duration-300 ${activeSlide === index ? 'bg-gold w-8' : 'bg-cream/30 hover:bg-cream/50'
                                        }`}
                                ></button>
                            ))}
                        </div>
